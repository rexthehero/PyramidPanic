...
namespace PyramidPanic
{
    public class BloomComponent
    {
        ...
        public void LoadContent()
        {
            ...
            //sceneRenderTarget = new ResolveTexture2D(game.GraphicsDevice, width, height, 1, 
            //    format);
            ...
            renderTarget1 = new RenderTarget2D(this.game.GraphicsDevice, width, height, false, format, DepthFormat.None); // init render target for full viewport size;       
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            //game.GraphicsDevice.(sceneRenderTarget);
